...
import (
	...
	"github.com/expensly/services/handlers"
	"github.com/expensly/services/libenv"
	"github.com/expensly/services/libunix"
	"github.com/expensly/services/middlewares"
...
func NewApplication() (*Application, error) {
	...
	dsn := libenv.EnvWithDefault("DSN", fmt.Sprintf("postgres://%v@localhost:5432/services?sslmode=disable", u))
	...
	cookieStoreSecret := libenv.EnvWithDefault("COOKIE_SECRET", "fuANhlJY9YU9beLo")
